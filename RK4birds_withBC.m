function [X,V] = RK4birds_withBC(X,V,P)
...
switch P.choiceBC
    case 1
        BC = str2func('circleImpact');
    case 2
        printf('error!');
    case 3
        BC = str2func('circleSoft');
    case 4
        BC = str2func('circleProximity');
    case 5
        printf('error!');
    case 6
        BC = str2func('squareImpact');
    case 7
        printf('error!');
    case 8
        BC = str2func('squareSoft');
    case 9
        BC = str2func('squareProximity');
    case 10
        printf('error!');
    otherwise
        BC = str2func('noBounds');
end
